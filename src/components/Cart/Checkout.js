  ...
  return (
    <form className={classes.form} onSubmit={confirmHandler}>
      ...
      >
        ...
        {!formInputsValid.name && <p>Wrong Name</p>}
      </div>
      <div
        className={`${classes.control} ${
      ...
      >
        ...
        {!formInputsValid.street && <p>Wrong Street</p>}
      </div>
      <div
        className={`${classes.control} ${
      ...
      >
        ...
        {!formInputsValid.postal && <p>Wrong Postal Code</p>}
      </div>
      <div
        className={`${classes.control} ${
      ...
      >
        ...
        {!formInputsValid.city && <p>Wrong City</p>}
      </div>
